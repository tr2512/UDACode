...
class ResNet101(nn.Module):
    def __init__(self, block, layers, num_classes):
        ...
        self.layer1 = self._make_layer(block, 64, layers[0], BatchNorm=nn.BatchNorm2d)
        self.layer2 = self._make_layer(block, 128, layers[1], stride=2, BatchNorm=nn.BatchNorm2d)
        self.layer3 = self._make_layer(block, 256, layers[2], stride=1, dilation=2, BatchNorm=nn.BatchNorm2d)
        self.layer4 = self._make_layer(block, 512, layers[3], stride=1, dilation=4, BatchNorm=nn.BatchNorm2d)
...
def Deeplab(BatchNorm, num_classes=21, restore_from=None, initialization=None):
